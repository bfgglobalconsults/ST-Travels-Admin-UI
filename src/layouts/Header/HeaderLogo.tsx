  ...
  return (
    <div className="header-logo-wrapper col-auto p-0">
      <div className="logo-wrapper">
        <Link href="/dashboard">
          <Image height={31.78} width={120.19} className="img-fluid main-logo" src={`${ImagePath}/logo/ST-TRAVELS.png`} alt="logo"/>
          <Image height={31.78} width={120.19} className="img-fluid white-logo" src={`${ImagePath}/logo/ST-TRAVELS-WHITE.png`} alt="logo"/>
        </Link>
      </div>
